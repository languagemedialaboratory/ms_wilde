...
class Config2:
    def __init__(self, main_conf_path):
        ...
        self.main_config = self.read_config(os.path.join(main_conf_path, 'main_config2.cfg'))
    ...
    def save(self, base_dir):
        ...
        with open(os.path.join(base_dir, 'main_config2.cfg'), 'wt') as f:
...
if __name__ == '__main__':
    param = Config2('../main_config2.cfg')
